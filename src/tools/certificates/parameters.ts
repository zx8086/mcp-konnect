...
export const getCertificateParameters = () => z.object({
  controlPlaneId: CommonSchemas.uuid
    .describe("Control Plane ID (obtainable from list-control-planes tool)"),
  certificateId: CommonSchemas.uuid
    .describe("Certificate ID (obtainable from list-certificates tool)"),
});
...
export const updateCertificateParameters = () => z.object({
  ...
  cert: z.string()
    .optional()
    .describe("Updated certificate in PEM format"),
  key: z.string()
    .optional()
    .describe("Updated private key in PEM format"),
  certAlt: z.string()
    .optional()
