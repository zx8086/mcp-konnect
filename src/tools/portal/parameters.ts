...
export const listApisParameters = () => z.object({
  ...
  filterStatus: z.enum(["published", "unpublished"])
    .optional()
...
export const fetchApiParameters = () => z.object({
  apiIdOrSlug: z.string()
    .describe("API ID or slug identifier")
});
...
export const fetchApiDocumentParameters = () => z.object({
  ...
  documentIdOrSlug: z.string()
    .describe("Document ID or slug identifier"),
  format: z.enum(["json", "yaml", "html", "markdown"])
    .default("json")
...
export const listApplicationsParameters = () => z.object({
  ...
  filterName: z.string()
    .optional()
    .describe("Filter applications by name"),
  filterAuthStrategy: z.string()
    .optional()
...
export const createApplicationParameters = () => z.object({
  ...
  authStrategyId: z.string()
    .optional()
    .describe("Authentication strategy ID"),
  scopes: z.array(z.string())
    .optional()
    .describe("Requested OAuth2 scopes")
});
...
export const updateApplicationParameters = () => z.object({
  ...
  redirectUri: z.string()
    .optional()
    .describe("New OAuth2 redirect URI"),
  scopes: z.array(z.string())
    .optional()
    .describe("New OAuth2 scopes")
});

export const deleteApplicationParameters = () => z.object({
  applicationId: z.string()
    .describe("Application ID to delete")
});
...
export const listApplicationRegistrationsParameters = () => z.object({
  ...
  pageNumber: z.number().int()
    ...
    .optional()
    .describe("Page number to retrieve"),
  filterStatus: z.enum(["pending", "approved", "rejected", "revoked"])
    .optional()
    .describe("Filter by registration status"),
  filterApiName: z.string()
    .optional()
    .describe("Filter by API name")
});
...
export const createApplicationRegistrationParameters = () => z.object({
  applicationId: z.string()
    .describe("Application ID"),
  apiId: z.string()
    .describe("API ID to register for"),
  apiProductVersionId: z.string()
    .optional()
...
export const deleteApplicationRegistrationParameters = () => z.object({
  applicationId: z.string()
    .describe("Application ID"),
  registrationId: z.string()
    .describe("Registration ID to delete")
});
...
export const createCredentialParameters = () => z.object({
  applicationId: z.string()
    .describe("Application ID"),
  credentialType: z.enum(["api_key", "oauth2", "basic_auth"])
    .describe("Type of credential to create"),
  name: z.string()
    .optional()
    .describe("Credential name/label"),
  scopes: z.array(z.string())
    .optional()
...
export const updateCredentialParameters = () => z.object({
  ...
  name: z.string()
    .optional()
    .describe("New credential name/label"),
  scopes: z.array(z.string())
    .optional()
    .describe("New OAuth2 scopes"),
  expiresAt: z.string()
...
export const deleteCredentialParameters = () => z.object({
  applicationId: z.string()
    .describe("Application ID"),
  credentialId: z.string()
    .describe("Credential ID to delete")
});
...
export const registerDeveloperParameters = () => z.object({
  email: z.string()
    .email()
    .describe("Developer email address"),
  fullName: z.string()
    .min(1)
    .describe("Developer full name"),
  password: z.string()
    .min(8)
    .describe("Password (minimum 8 characters)"),
  organization: z.string()
    .optional()
    .describe("Developer organization"),
