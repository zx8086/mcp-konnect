...
describe('Simplified Universal Elicitation', () => {
  ...
  describe('SimpleElicitationManager', () => {
    ...
    describe('Message Pattern Extraction', () => {
      ...
      test('should prefer provided context over extracted', async () => {
        ...
        const provided = { domain: 'provided', environment: 'provided', team: 'provided' };
    ...
    describe('Missing Field Detection', () => {
      ...
      test('should succeed when all fields provided', async () => {
        const provided = { domain: 'api', environment: 'production', team: 'platform' };
    ...
    describe('Tag Generation', () => {
      test('should generate correct tags for different entity types', () => {
        const context = { domain: 'api', environment: 'production', team: 'platform' };
  ...
  describe('SimpleElicitationTool', () => {
    ...
    describe('Context Gathering Integration', () => {
      ...
      test('should handle provided context parameter', async () => {
        const provided = { domain: 'backend', environment: 'staging', team: 'devops' };
    ...
    describe('Tag Generation', () => {
      test('should generate entity-specific tags', () => {
        const context = { domain: 'platform', environment: 'staging', team: 'infrastructure' };
  ...
  describe('Real-world Scenarios', () => {
    ...
    test('should handle enterprise shared services scenario', async () => {
      const userMessage = 'migrate enterprise config: domain=shared_services, environment=staging, team=global_platform_engineering';
  ...
  describe('Performance and Edge Cases', () => {
    ...
    test('should handle very long user messages efficiently', async () => {
      const longMessage = 'deploy Kong configuration with lots of details and information but also domain=api, environment=production, team=platform at the end after many words '.repeat(100);
